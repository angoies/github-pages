...
### 3.2 Clonar 
```console
usuario@mdebian10:~/prj$ git config --global user.name "Jose GÃ³mez"
...
Unresumen rápido: https://code.visualstudio.com/docs/editor/versioncontrol

### Crear una página index.html
Nuevo fichero, etc...
Añadir al stage, commit con mensaje. REcordaemos que se actualiza repositorio local, no remoto.
